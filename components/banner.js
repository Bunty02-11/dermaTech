          ...
          <div className={styles.content}>
            ...
            <div className={styles.filter}>
              <div className={styles.loremIpsumDolor1}>
                Discover cutting-edge skincare solutions at DermaTech
                personalized treatments to rejuvenate, protect, and enhance your
                skin for a radiant, youthful glow.
              </div>
            </div>
            <div className={styles.btns}>
              <a
                href="/contact"
                className={`${styles.btnBook} ${styles.noUnderline}`}
              >
                <div
      ...
      <Carousel.Item>
        ...
        >
          <div className={styles.content}>
            ...
            <div className={styles.filter}>
              <div className={styles.loremIpsumDolor1}>
                Enhance your skin with advanced, personalized treatments at
                DermaTech. Address acne, pigmentation, and aging with expert
      ...
      <Carousel.Item>
        ...
        >
          <div className={styles.content}>
            ...
            <div className={styles.filter}>
              <div className={styles.loremIpsumDolor1}>
                Achieve a sculpted look with DermaTech's Fat Freezing in Dubai
                and experience advanced, personalized body contouring treatments
